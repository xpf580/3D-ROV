...
def main():
    ...
    if args.mode == 'train':
        ...
        print('探索%d次' % explore_mun)
        print("结束")
        # del return_list[0:explore_mun]
        # del mean_return_list[0:explore_mun]
        # del each_step[0:explore_mun]
        ...
        dic = {'gamma': args.gamma, 'capacity': args.capacity, 'sample_frequency': args.sample_frequency, 'policy_noise': args.policy_noise,
               'noise_clip': args.noise_clip, 'policy_delay': args.policy_delay, 'exploration_noise': args.exploration_noise, 'actor_lr': 1e-4,
